...
namespace PracticaBiblioteca.Controllers
{
    public class AutorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdAutor,Descripcion,Estado,FechaCreacion")] Autor autor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAutor,Descripcion,Estado,FechaCreacion")] Autor autor)
        {
            if (id != autor.IdAutor)
            {
                return NotFound();

...
namespace PracticaBiblioteca.Controllers
{
    public class PersonasController : Controller
    {
        ...
        public PersonasController(BibliotecaContext context)
        {
            _context = context;
        }
        ...
        {
            var bibliotecaContext = _context.Personas.Include(p => p.IdTipoPersonaNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdPersona,Nombre,Apellido,Correo,Clave,Codigo,IdTipoPersona,Estado,FechaCreacion")] Persona persona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPersona,Nombre,Apellido,Correo,Clave,Codigo,IdTipoPersona,Estado,FechaCreacion")] Persona persona)
        {
